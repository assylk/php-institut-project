...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS =>'{
    ...
    "accept_card": "true",
    "amount": "'.$amount.'",
    "success_link": "https://assylchouikh.rf.gd/paiemenet.php?amount='.$amount.'&&studentID='.$studentID.'&&coursepin='.$coursepin.'",
    "fail_link": "https://assylchouikh.rf.gd/paiemenet.php?amount='.$amount.'&&studentID='.$studentID.'&&coursepin='.$coursepin.'",
