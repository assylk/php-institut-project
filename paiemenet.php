...
$ret=mysqli_query($con,"insert into enrolledCourses(studentID,paiementID,price,courseID,author) values('$studentID','$payment_id','$amount','$coursepin','$studentID')");
...
<body>
    ...
    <script>
    setTimeout(function() {
        window.location = "http://localhost/kes/index.php";
    }, 5000);
    </script>
</body>
</html>